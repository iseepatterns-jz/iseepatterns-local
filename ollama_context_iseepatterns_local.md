...
1. List the contents of the `.agent/skills/` directory (relative path: `.agent/skills/`).
2. Identify the main rule/config files inside `.agent/skills` (for example files like
