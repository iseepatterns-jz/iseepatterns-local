...
Optional:
  --register-coc     Register all outputs in lawmodel1 chain_of_custody
  --coc-db PATH      Path to mbox_index.db
  --owner-handle +17736109104   Your own phone number (default: +17736109104)
